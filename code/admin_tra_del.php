...
<html>
	...
	<body>
        ...
        //此為刪除車班頁面
        echo '<font size="6"><strong>所有車班資訊</strong><br><br>';
        ...
        echo '<form name="form" method="post" action="admin_tra_del_seq.php">';
        echo '<br><br><br><font size="4"><strong>請輸入要刪除的車次代碼：<input type="text" name="train_id_del_seq" /> ';
